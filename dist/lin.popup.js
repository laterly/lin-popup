...
function getRandom(e) {
    return Math.ceil(Math.random() * Number(e));
}

function isJSONStr(e) {
    if ("string" != typeof e) return !1;
    try {
        return "object" == _typeof(JSON.parse(e));
    } catch (e) {
        return !1;
    }
}
...
function createMask() {
    ...
    e.setAttribute("id", "mask"), e.setAttribute("style", "width: 100%;height: 100%;position: fixed;left: 0;top: 0;z-index:100; background:rgba(0,0,0,0);"), 
    document.querySelector("body").appendChild(e);
}

function creatToastClass(e) {
    createMask();
    var t = getRandom(100), n = "<span>".concat(e, "</span>"), A = document.createElement("div");
    return A.innerHTML = n, A.setAttribute("id", t), A.setAttribute("style", "\n    position: fixed;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%,-50%);\n    display:inline-block;\n    padding:5px 20px; \n    background:rgba(0,0,0,0.5); \n    border-radius:20px;\n    font-size:14px;\n    color:#fff;\n    z-index:101;\n    "), 
    document.querySelector("body").appendChild(A), t;
}

function creatIconClass(e, t) {
    createMask();
    var n = getRandom(100), A = '\n    <img style="width:38px" src="'.concat(t, '">\n    <span style="').concat("\n    font-size:14px;\n    text-align: center;\n    margin-top:5px;\n    color:#fff;\n    ", '">').concat(e, "</span>"), i = document.createElement("div");
    return i.innerHTML = A, i.setAttribute("id", n), i.setAttribute("style", "\n    position: fixed;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%,-50%);\n    display:inline-block;\n    padding:20px 30px;\n    background:rgba(0,0,0,0.5);\n    border-radius:4px;\n    font-size:14px;\n    display:flex; \n    flex-flow: column wrap;\n    align-items: center;\n    display:flex; \n    flex-flow: column wrap;\n    align-items: center; \n    justify-content: center;\n    z-index:101;\n    "), 
    document.querySelector("body").appendChild(i), n;
}

function beforeToast(e) {
    return isEmptyObj(e) ? {
        text: "操作成功",
        duration: 2e3
    } : isJSONStr(e) ? e : isString(e) ? {
        text: e,
        duration: 2e3
    } : {
        text: "操作成功",
...
function setDuration(e, t) {
    var n = document.getElementById("".concat(e)), A = document.getElementById("mask");
    setTimeout(function() {
        n.parentNode.removeChild(n), A.parentNode.removeChild(A);
    }, t);
}

function createToast(e, t, n) {
    var A = beforeToast(e), i = A.text, r = A.duration, o = null;
    1 === t ? o = creatToastClass(i) : 2 === t && (o = creatIconClass(i, n)), setDuration(o, r);
}
...
function createToast$1(e, t) {
    var n = beforeToast$1(e), A = n.text;
    return creatIconClass$1(A, t);
}
